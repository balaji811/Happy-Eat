...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Login specific form styling - dark theme */
        .login-heading {
            font-size: 2rem;
            font-weight: 800;
            color: #d4c9bc;
        ...
        /* ========= RESPONSIVE ========= */
        @media (max-width: 880px) {
            .login-card { flex-direction: column; border-radius: 32px; }
            .form-col { order: 1; padding: 32px 24px; }
            .visual-col { order: 2; min-height: 260px; }
                ...
                <form id="loginForm" action="Login" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="password-wrapper">
                            <input type="password" id="password" name="password" class="input-underline" autocomplete="current-password" placeholder="Enter your password">
                    ...
                    <button type="submit" class="btn-primary" id="loginBtn"><i class="fas fa-arrow-right-to-bracket"></i> Sign in</button>
                </form>

                

                <div class="register-footer">
                    Don't have an account? <a id="registerLink" href="Register">Create account</a>
                </div>
            </div>

            <!-- RIGHT: Image Column (food illustration) -->
